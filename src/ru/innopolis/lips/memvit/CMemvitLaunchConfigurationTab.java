...
import org.eclipse.cdt.launch.internal.ui.LaunchUIPlugin; // TODO: find new "version"
...
public class CMemvitLaunchConfigurationTab extends CLaunchConfigurationTab {
	...
	public void setDefaults(ILaunchConfigurationWorkingCopy config) {    
		...
		config.setAttribute(ICDTLaunchConfigurationConstants.ATTR_DEBUGGER_ID, "GDBCDIDebuggerCMemvit");
		...
		try {
			...
			debugger = config.getAttribute("gdb", "");
			
			// if (debugger.equals("")){debugger = config.getAttribute(IMILaunchConfigurationConstants.ATTR_DEBUG_NAME, "");}
			if (debugger.equals("")){debugger = config.getAttribute("org.eclipse.cdt.debug.mi.core" + ".DEBUG_NAME", "");}
	...
	public void initializeFrom(ILaunchConfiguration config) {
		try {
			...
			debugIDText.setText("GDBCDIDebuggerCMemvit");
	...
	public void performApply(ILaunchConfigurationWorkingCopy config) {
		...
		config.setAttribute("org.eclipse.cdt.debug.mi.core" + ".DEBUG_NAME", debuggerText.getText()); //$NON-NLS-2$
		
		// config.setAttribute(IMILaunchConfigurationConstants.DEBUGGER_DEBUG_NAME_DEFAULT, debuggerText.getText());
		config.setAttribute("gdb", debuggerText.getText()); //$NON-NLS-1$
	}
	
	@Override
	// Set a name for the configuration tag
	public String getName() {
		return "CMemvit Neon Configuration"; // TODO: remove "Neon"
	}
